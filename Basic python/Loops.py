...
# 10. prime number is always greater than 1
if number > 1:
...
# 11. if the entered number is less than or equal to 1
# then it is not prime number
else:
    print(number, "is not a prime number")

# 12 .Write a program to palindrome or not.
...
# 12. Program to check whether a number is EVEN or ODD.
